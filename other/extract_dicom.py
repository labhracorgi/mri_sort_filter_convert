...
for i in dicomsorted_dirs:
    ...
    for j in id_list:
        ...
        patient_name    = re.sub(""" Troms\\xf87\^\^\^""","",str(patient_name))
        ...
        patient_coil_used_actually = this_dicom_object[pydicom.tag.Tag(0x0051100f)] #Seems to require some formatting.
        patient_coil_used_actually = str(patient_coil_used_actually)
        patient_coil_used_actually = re.split('\s',patient_coil_used_actually)[-1].replace("""'""","")
        #pydicom.tag.Tag(0x0051100f) This creates a tag at least... 
        ...
        print "Coil Info more: " + patient_coil_used_actually
        #Writing to csv:
        list_of_interest = [j,
                            patient_id,
                            patient_age,
