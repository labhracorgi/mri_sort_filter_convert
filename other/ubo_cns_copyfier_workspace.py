...
def ubo_copy_from_clean_to_workspace(source_dir,target_dir):
...
copy_to = "/home/lars/Desktop/testing_dicomsort/test_ubo_nifti/"

ubo_copy_from_clean_to_workspace(copy_from,copy_to)
